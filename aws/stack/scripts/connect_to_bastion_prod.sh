...
echo $(aws ec2-instance-connect send-ssh-public-key --instance-id "$BASTION_INSTANCE_ID" --region "eu-central-1" --availability-zone "eu-central-1a" --instance-os-user "ec2-user" --profile "haas-prod" --ssh-public-key "file:///tmp/rds_rsa.pub")
