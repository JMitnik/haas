# Migration `20210516202212-fresh-start-v3`

This migration has been generated by Jonathan at 5/16/2021, 10:22:12 PM.
...
CREATE TYPE "public"."CampaignVariantEdgeConditionEnum" AS ENUM ('ON_NOT_FINISHED', 'ON_NOT_OPENED')

ALTER TABLE "public"."Topic" DROP CONSTRAINT "Topic_relatedDialogueId_fkey"

ALTER TABLE "public"."TopicValue" DROP CONSTRAINT "TopicValue_parentTopicId_fkey"

ALTER TABLE "public"."QuestionNode" DROP CONSTRAINT "QuestionNode_relatedTopicId_fkey"

ALTER TABLE "public"."QuestionOption" DROP CONSTRAINT "QuestionOption_relatedTopicValueId_fkey"

ALTER TABLE "public"."CampaignVariant" ADD COLUMN "depth" integer   NOT NULL DEFAULT 0,
ADD COLUMN "scheduleType" "CampaignVariantScheduleTypeEnum"  NOT NULL DEFAULT E'GENERAL'

ALTER TABLE "public"."Delivery" ADD COLUMN "relatedSubscriptionId" text   ,
ADD COLUMN "message" text   ,
ADD COLUMN "errorMessage" text   

ALTER TABLE "public"."QuestionNode" DROP COLUMN "relatedTopicId"

ALTER TABLE "public"."QuestionOption" DROP COLUMN "relatedTopicValueId"
...
"parentCampaignVariantId" text   NOT NULL ,
"childCampaignVariantId" text   NOT NULL ,
PRIMARY KEY ("id")
)
...
CREATE UNIQUE INDEX "CampaignVariantEdge_parentCampaignVariantId_unique" ON "public"."CampaignVariantEdge"("parentCampaignVariantId")

ALTER TABLE "public"."CampaignVariantEdge" ADD FOREIGN KEY ("parentCampaignVariantId")REFERENCES "public"."CampaignVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE
