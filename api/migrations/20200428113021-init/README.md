# Migration `20200428113021-init`

This migration has been generated by Cold-A-Muse at 4/28/2020, 11:30:21 AM.
...
ALTER TABLE "public"."QuestionCondition" ADD FOREIGN KEY ("edgeId")REFERENCES "public"."Edge"("id") ON DELETE CASCADE  ON UPDATE CASCADE
...
ALTER TABLE "public"."NodeEntryValue" ADD FOREIGN KEY ("parentNodeEntryId")REFERENCES "public"."NodeEntry"("id") ON DELETE SET NULL  ON UPDATE CASCADE
...
+  // // yea geen idee waar deze voor is maar ik laat em staan
