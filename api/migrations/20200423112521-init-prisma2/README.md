# Migration `20200423112521-init-prisma2`

This migration has been generated by Cold-A-Muse at 4/23/2020, 11:25:21 AM.
...
CREATE UNIQUE INDEX "CustomerSettings_customerId" ON "public"."CustomerSettings"("customerId")
...
+}
+
+//FIXME: remove maps from all models
+
