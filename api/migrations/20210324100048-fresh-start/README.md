# Migration `20210324100048-fresh-start`

This migration has been generated by Cold-A-Muse at 3/24/2021, 5:00:48 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TYPE "public"."TagEnum" AS ENUM ('DEFAULT', 'AGENT', 'LOCATION')

CREATE TYPE "public"."NodeType" AS ENUM ('GENERIC', 'SLIDER', 'FORM', 'CHOICE', 'REGISTRATION', 'TEXTBOX', 'LINK', 'SHARE')

CREATE TYPE "public"."FormNodeFieldType" AS ENUM ('email', 'phoneNumber', 'url', 'shortText', 'longText', 'number')

CREATE TYPE "public"."LinkTypeEnum" AS ENUM ('SOCIAL', 'API', 'FACEBOOK', 'LINKEDIN', 'WHATSAPP', 'INSTAGRAM', 'TWITTER')

CREATE TYPE "public"."InputSource" AS ENUM ('CLIENT', 'INIT_GENERATED')

CREATE TYPE "public"."SystemPermissionEnum" AS ENUM ('CAN_ACCESS_ADMIN_PANEL', 'CAN_EDIT_DIALOGUE', 'CAN_BUILD_DIALOGUE', 'CAN_VIEW_DIALOGUE', 'CAN_DELETE_DIALOGUE', 'CAN_VIEW_DIALOGUE_ANALYTICS', 'CAN_VIEW_USERS', 'CAN_ADD_USERS', 'CAN_DELETE_USERS', 'CAN_EDIT_USERS', 'CAN_CREATE_TRIGGERS', 'CAN_DELETE_TRIGGERS', 'CAN_DELETE_WORKSPACE', 'CAN_EDIT_WORKSPACE', 'CAN_VIEW_CAMPAIGNS', 'CAN_CREATE_CAMPAIGNS', 'CAN_CREATE_DELIVERIES')

CREATE TYPE "public"."RoleTypeEnum" AS ENUM ('ADMIN', 'MANAGER', 'USER', 'GUEST', 'CUSTOM')

CREATE TYPE "public"."TriggerEnum" AS ENUM ('QUESTION', 'SCHEDULED')

CREATE TYPE "public"."TriggerMedium" AS ENUM ('EMAIL', 'PHONE', 'BOTH')

CREATE TYPE "public"."TriggerConditionEnum" AS ENUM ('LOW_THRESHOLD', 'HIGH_THRESHOLD', 'INNER_RANGE', 'OUTER_RANGE', 'TEXT_MATCH')

CREATE TYPE "public"."JobType" AS ENUM ('CREATE_WORKSPACE_JOB')

CREATE TYPE "public"."CloudReferenceType" AS ENUM ('AWS', 'GCP', 'Azure', 'IBM')

CREATE TYPE "public"."JobStatusType" AS ENUM ('PRE_PROCESSING', 'PRE_PROCESSING_LOGO', 'PRE_PROCESSING_WEBSITE_SCREENSHOT', 'READY_FOR_PROCESSING', 'IN_PHOTOSHOP_QUEUE', 'PHOTOSHOP_PROCESSING', 'PROCESSING', 'WRAPPING_UP', 'PENDING', 'COMPLETED', 'FAILED')
