# Migration `20200727170845-test`

This migration has been generated at 7/27/2020, 5:08:45 PM.
...
"createdAt" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY ("userId","customerId","roleId"))
...
ALTER TABLE "public"."Trigger" ADD FOREIGN KEY ("userOfCustomerUserId", "userOfCustomerCustomerId", "userOfCustomerRoleId")REFERENCES "public"."UserOfCustomer"("userId","customerId","roleId") ON DELETE SET NULL  ON UPDATE CASCADE
...
migration 20200727164736-user-customer-to-many-to-many..20200727170845-test
--- datamodel.dml
+++ datamodel.dml
@@ -1,7 +1,7 @@
