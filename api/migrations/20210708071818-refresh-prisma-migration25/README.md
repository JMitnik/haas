# Migration `20210708071818-refresh-prisma-migration25`

This migration has been generated by Jonathan at 7/8/2021, 9:18:19 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
CREATE TYPE "public"."CampaignVariantScheduleTypeEnum" AS ENUM ('GENERAL', 'RECURRING', 'FOLLOW_UP')

CREATE TYPE "public"."CampaignVariantEdgeConditionEnum" AS ENUM ('AB_SAMPLING', 'ON_NOT_FINISHED', 'ON_NOT_OPENED')

CREATE TYPE "public"."CampaignScheduleMetric" AS ENUM ('MONTH', 'WEEK', 'DAY', 'HOUR')

ALTER TABLE "public"."CampaignVariant" ADD COLUMN "campaignId" text   ,
ADD COLUMN "depth" integer   NOT NULL DEFAULT 0

ALTER TABLE "public"."Delivery" ADD COLUMN "relatedSubscriptionId" text   ,
ADD COLUMN "message" text   ,
ADD COLUMN "errorMessage" text   

ALTER TABLE "public"."FormNode" ADD COLUMN "helperText" text   

ALTER TABLE "public"."Session" ADD COLUMN "consumerId" text   
...
CREATE TABLE "public"."CampaignVariantEdgeCondition" (
"id" text   NOT NULL ,
"campaignVariantEdgeId" text   NOT NULL ,
"AB__Weight" integer   ,
PRIMARY KEY ("id")
)

CREATE TABLE "public"."CampaignVariantEdge" (
"id" text   NOT NULL ,
"campaignId" text   NOT NULL ,
"directCampaignId" text   ,
"condition" "CampaignVariantEdgeConditionEnum"  ,
"parentCampaignVariantId" text   ,
"childCampaignVariantId" text   ,
"scheduleType" "CampaignVariantScheduleTypeEnum"  NOT NULL DEFAULT E'GENERAL',
"scheduleMetric" "CampaignScheduleMetric"  ,
"scheduleAmount" integer   ,
PRIMARY KEY ("id")
)

CREATE TABLE "public"."CampaignVariantSubscription" (
"id" text   NOT NULL ,
"userId" text   ,
"consumerId" text   ,
"rootCampaignVariantId" text   NOT NULL ,
"isActive" boolean   NOT NULL DEFAULT true,
"campaignVariantEdgeId" text   ,
PRIMARY KEY ("id")
)

CREATE UNIQUE INDEX "CampaignVariantEdgeCondition.campaignVariantEdgeId_unique" ON "public"."CampaignVariantEdgeCondition"("campaignVariantEdgeId")
...
ALTER TABLE "public"."CampaignVariantEdgeCondition" ADD FOREIGN KEY ("campaignVariantEdgeId")REFERENCES "public"."CampaignVariantEdge"("id") ON DELETE CASCADE ON UPDATE CASCADE
...
ALTER TABLE "public"."CampaignVariantEdge" ADD FOREIGN KEY ("directCampaignId")REFERENCES "public"."Campaign"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."CampaignVariantEdge" ADD FOREIGN KEY ("parentCampaignVariantId")REFERENCES "public"."CampaignVariant"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."CampaignVariantEdge" ADD FOREIGN KEY ("childCampaignVariantId")REFERENCES "public"."CampaignVariant"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."CampaignVariantSubscription" ADD FOREIGN KEY ("userId")REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."CampaignVariantSubscription" ADD FOREIGN KEY ("consumerId")REFERENCES "public"."Consumer"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."CampaignVariantSubscription" ADD FOREIGN KEY ("rootCampaignVariantId")REFERENCES "public"."CampaignVariant"("id") ON DELETE CASCADE ON UPDATE CASCADE

ALTER TABLE "public"."CampaignVariantSubscription" ADD FOREIGN KEY ("campaignVariantEdgeId")REFERENCES "public"."CampaignVariantEdge"("id") ON DELETE SET NULL ON UPDATE CASCADE
...
ALTER TABLE "public"."Delivery" ADD FOREIGN KEY ("relatedSubscriptionId")REFERENCES "public"."CampaignVariantSubscription"("id") ON DELETE SET NULL ON UPDATE CASCADE

ALTER TABLE "public"."Session" ADD FOREIGN KEY ("consumerId")REFERENCES "public"."Consumer"("id") ON DELETE SET NULL ON UPDATE CASCADE
```
