# Migration `20210612225833-restart-v13`

This migration has been generated by Jonathan at 6/13/2021, 12:58:33 AM.
...
ALTER TYPE "CampaignVariantEdgeConditionEnum" ADD VALUE 'AB_SAMPLING'

ALTER TABLE "public"."CampaignVariant" DROP COLUMN "scheduleType"

ALTER TABLE "public"."CampaignVariantEdge" ADD COLUMN "scheduleType" "CampaignVariantScheduleTypeEnum"  NOT NULL DEFAULT E'GENERAL'

ALTER TABLE "public"."CampaignVariantSubscription" ADD COLUMN "campaignVariantEdgeId" text   
