...
-- CreateIndex
CREATE UNIQUE INDEX "CustomerSettings_colourSettingsId_unique" ON "CustomerSettings"("colourSettingsId");

-- CreateIndex
CREATE UNIQUE INDEX "CustomerSettings_fontSettingsId_unique" ON "CustomerSettings"("fontSettingsId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Dialogue_postLeafNodeId_unique" ON "Dialogue"("postLeafNodeId");

-- CreateIndex
CREATE UNIQUE INDEX "FormNodeEntry_nodeEntryId_unique" ON "FormNodeEntry"("nodeEntryId");

-- CreateIndex
CREATE UNIQUE INDEX "Share_questionNodeId_unique" ON "Share"("questionNodeId");

-- CreateIndex
CREATE UNIQUE INDEX "VideoNodeEntry_nodeEntryId_unique" ON "VideoNodeEntry"("nodeEntryId");

-- CreateIndex
CREATE UNIQUE INDEX "LinkNodeEntry_nodeEntryId_unique" ON "LinkNodeEntry"("nodeEntryId");

-- CreateIndex
CREATE UNIQUE INDEX "SliderNodeEntry_nodeEntryId_unique" ON "SliderNodeEntry"("nodeEntryId");

-- CreateIndex
CREATE UNIQUE INDEX "ChoiceNodeEntry_nodeEntryId_unique" ON "ChoiceNodeEntry"("nodeEntryId");

-- CreateIndex
CREATE UNIQUE INDEX "TextboxNodeEntry_nodeEntryId_unique" ON "TextboxNodeEntry"("nodeEntryId");

-- CreateIndex
CREATE UNIQUE INDEX "RegistrationNodeEntry_nodeEntryId_unique" ON "RegistrationNodeEntry"("nodeEntryId");
...
-- CreateIndex
CREATE UNIQUE INDEX "Job_createWorkspaceJobId_unique" ON "Job"("createWorkspaceJobId");
