# Migration `20201202120111-reset2`

This migration has been generated by Jonathan at 12/2/2020, 1:01:11 PM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."QuestionNode" DROP COLUMN "formNodeId",
ADD COLUMN "sliderNodeId" integer   

DROP TYPE "FormNodeFieldType"
...
"sliderNodeRangeId" integer   NOT NULL ,
PRIMARY KEY ("id")
)

CREATE TABLE "public"."SliderNode" (
"id" SERIAL,
"sliderNodeMarkerId" integer   NOT NULL ,
PRIMARY KEY ("id")
)
...
ALTER TABLE "public"."SliderNode" ADD FOREIGN KEY ("sliderNodeMarkerId")REFERENCES "public"."SliderNodeMarker"("id") ON DELETE CASCADE ON UPDATE CASCADE
