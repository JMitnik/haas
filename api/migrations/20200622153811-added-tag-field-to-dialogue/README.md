# Migration `20200622153811-added-tag-field-to-dialogue`

This migration has been generated by Cold-A-Muse at 6/22/2020, 3:38:11 PM.
...
ALTER TABLE "public"."Tag" ADD FOREIGN KEY ("dialogueId")REFERENCES "public"."Dialogue"("id") ON DELETE SET NULL  ON UPDATE CASCADE
```
