# Migration `20210802042654-add-prefix-to`

This migration has been generated by Jonathan at 8/2/2021, 6:26:54 AM.
You can check out the [state of the schema](./schema.prisma) after the migration.

## Database Steps

```sql
ALTER TABLE "public"."ConsumerSubscription" DROP CONSTRAINT "ConsumerSubscription_consumerId_fkey"

ALTER TABLE "public"."Delivery" DROP CONSTRAINT "Delivery_subscriptionId_fkey"

ALTER TABLE "public"."Delivery" DROP COLUMN "subscriptionId",
ADD COLUMN "deliveryRecipientPrefix" text   
...
DROP TABLE "public"."ConsumerSubscription"
```
