...
const authShield = shield({
  ...
  Customer: {
    actionableConnection: or(isSuperAdmin, containsWorkspacePermission(SystemPermissionEnum.CAN_VIEW_ACTION_REQUESTS)),
  ...
  Mutation: {
    ...
    assignUserToActionable: or(isSuperAdmin, containsWorkspacePermission(SystemPermissionEnum.CAN_ACCESS_ALL_ACTION_REQUESTS)),
    setActionableStatus: or(isSuperAdmin, containsWorkspacePermission(SystemPermissionEnum.CAN_ACCESS_ALL_ACTION_REQUESTS)),
