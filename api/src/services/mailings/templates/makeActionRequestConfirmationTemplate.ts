...
interface makeActionRequestConfirmationTemplateProps {
...
const makeActionRequestConfirmationTemplate = ({ recipientMail, verifyUrl, bgColor = '#0059f8', assigneeName }: makeActionRequestConfirmationTemplateProps) => {
  ...
  <mj-body background-color=${bgColor}>
      ...
      ${verifyUrl && `
          ...
          <mj-button href="${verifyUrl}" background-color="#36d399">
          ✨ Confirm
          </mj-button>
      `}
          </mj-column>
...
export default makeActionRequestConfirmationTemplate;
