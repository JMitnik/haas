...
export interface NexusGenInputs {
  ...
  CreateTopicInput: { // input type
    ...
    label: string; // String!
    relatedDialogueSlug: string; // String!
    topicValues?: NexusGenInputs['CreateTopicValueInput'][] | null; // [CreateTopicValueInput!]
  }
  CreateTopicValueInput: { // input type
    label?: string | null; // String
  }
  ...
  OptionInputType: { // input type
    ...
    topicValueId?: string | null; // String
    value?: string | null; // String
  }
...
export interface NexusGenRootTypes {
  ...
  Tag: prisma.Tag;
  TopicModel: { // root type
    id: string; // ID!
    label: string; // String!
  }
  TopicValueModel: { // root type
    id: string; // ID!
    label: string; // String!
  }
...
export interface NexusGenAllTypes extends NexusGenRootTypes {
  ...
  CreateTopicInput: NexusGenInputs['CreateTopicInput'];
  CreateTopicValueInput: NexusGenInputs['CreateTopicValueInput'];
  ...
  EditTopicInput: NexusGenInputs['EditTopicInput'];
...
export interface NexusGenFieldTypes {
  ...
  CreateTopicOutput: { // field return type
    id: string; // String!
  }
  ...
  Dialogue: { // field return type
    ...
    title: string; // String!
    topics: NexusGenRootTypes['TopicModel'][]; // [TopicModel!]!
    updatedAt: string | null; // String
  ...
  EditTopicOutput: { // field return type
    id: string; // String!
  }
  ...
  Mutation: { // field return type
    ...
    createTopic: NexusGenRootTypes['CreateTopicOutput']; // CreateTopicOutput!
    ...
    editTopic: NexusGenRootTypes['EditTopicOutput']; // EditTopicOutput!
  ...
  TopicModel: { // field return type
    id: string; // ID!
    label: string; // String!
    topicValues: NexusGenRootTypes['TopicValueModel'][]; // [TopicValueModel!]!
  }
  TopicValueModel: { // field return type
    id: string; // ID!
    label: string; // String!
  }
...
export interface NexusGenArgTypes {
  ...
  Mutation: {
    ...
    editTopic: { // args
      input?: NexusGenInputs['EditTopicInput'] | null; // EditTopicInput
    }
    editTrigger: { // args
      customerSlug?: string | null; // String
      recipients?: NexusGenInputs['RecipientsInputType'] | null; // RecipientsInputType
