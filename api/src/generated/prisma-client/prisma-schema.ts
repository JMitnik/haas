...
type Mutation {
  ...
  createQQuestion(data: QQuestionCreateInput!): QQuestion!
  updateQQuestion(data: QQuestionUpdateInput!, where: QQuestionWhereUniqueInput!): QQuestion
  updateManyQQuestions(data: QQuestionUpdateManyMutationInput!, where: QQuestionWhereInput): BatchPayload!
  upsertQQuestion(where: QQuestionWhereUniqueInput!, create: QQuestionCreateInput!, update: QQuestionUpdateInput!): QQuestion!
  deleteQQuestion(where: QQuestionWhereUniqueInput!): QQuestion
  deleteManyQQuestions(where: QQuestionWhereInput): BatchPayload!
...
type QQuestionConnection {
  pageInfo: PageInfo!
  edges: [QQuestionEdge]!
  aggregate: AggregateQQuestion!
}

input QQuestionCreateInput {
  id: ID
  title: String!
  branchVal: String
  questionType: String!
...
input QQuestionCreateManyInput {
  create: [QQuestionCreateInput!]
  connect: [QQuestionWhereUniqueInput!]
}
...
input QQuestionScalarWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  AND: [QQuestionScalarWhereInput!]
  OR: [QQuestionScalarWhereInput!]
  NOT: [QQuestionScalarWhereInput!]
}

type QQuestionSubscriptionPayload {
  mutation: MutationType!
  node: QQuestion
  updatedFields: [String!]
...
input QQuestionSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: QQuestionWhereInput
  AND: [QQuestionSubscriptionWhereInput!]
  OR: [QQuestionSubscriptionWhereInput!]
  NOT: [QQuestionSubscriptionWhereInput!]
}

input QQuestionUpdateDataInput {
  title: String
  branchVal: String
  questionType: String
  overrideLeafId: Int
...
input QQuestionUpdateManyDataInput {
  title: String
  branchVal: String
  questionType: String
  overrideLeafId: Int
...
input QQuestionUpdateManyInput {
  create: [QQuestionCreateInput!]
  update: [QQuestionUpdateWithWhereUniqueNestedInput!]
  upsert: [QQuestionUpsertWithWhereUniqueNestedInput!]
  delete: [QQuestionWhereUniqueInput!]
  connect: [QQuestionWhereUniqueInput!]
  set: [QQuestionWhereUniqueInput!]
  disconnect: [QQuestionWhereUniqueInput!]
  deleteMany: [QQuestionScalarWhereInput!]
  updateMany: [QQuestionUpdateManyWithWhereNestedInput!]
}

input QQuestionUpdateManyMutationInput {
  title: String
  branchVal: String
  questionType: String
  overrideLeafId: Int
...
input QQuestionUpdateManyWithWhereNestedInput {
  where: QQuestionScalarWhereInput!
  data: QQuestionUpdateManyDataInput!
}

input QQuestionUpdateWithWhereUniqueNestedInput {
  where: QQuestionWhereUniqueInput!
  data: QQuestionUpdateDataInput!
}

input QQuestionUpsertWithWhereUniqueNestedInput {
  where: QQuestionWhereUniqueInput!
  update: QQuestionUpdateDataInput!
  create: QQuestionCreateInput!
}

input QQuestionWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  children_every: QQuestionWhereInput
  children_some: QQuestionWhereInput
  children_none: QQuestionWhereInput
  AND: [QQuestionWhereInput!]
  OR: [QQuestionWhereInput!]
  NOT: [QQuestionWhereInput!]
}

input QQuestionWhereUniqueInput {
  id: ID
}
...
type Query {
  ...
  qQuestion(where: QQuestionWhereUniqueInput!): QQuestion
  qQuestions(where: QQuestionWhereInput, orderBy: QQuestionOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [QQuestion]!
  qQuestionsConnection(where: QQuestionWhereInput, orderBy: QQuestionOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): QQuestionConnection!
...
input QuestionnaireCreateInput {
  ...
  questions: QQuestionCreateManyInput
}
...
input QuestionnaireCreateOneWithoutSettingInput {
...
input QuestionnaireCreateWithoutSettingInput {
  id: ID
  customer: CustomerCreateOneWithoutQuestionnairesInput!
  title: String!
  description: String!
...
input QuestionnaireSettingsCreateOneWithoutQuestionnaireInput {
  create: QuestionnaireSettingsCreateWithoutQuestionnaireInput
  connect: QuestionnaireSettingsWhereUniqueInput
}

input QuestionnaireSettingsCreateWithoutQuestionnaireInput {
  id: ID
  customer: CustomerCreateOneInput!
  title: String
  logo: String
...
input QuestionnaireSettingsUpdateInput {
  ...
  questionnaire: QuestionnaireUpdateOneRequiredWithoutSettingInput
  title: String
  logo: String
...
input QuestionnaireSettingsUpdateOneRequiredWithoutQuestionnaireInput {
  create: QuestionnaireSettingsCreateWithoutQuestionnaireInput
  update: QuestionnaireSettingsUpdateWithoutQuestionnaireDataInput
  upsert: QuestionnaireSettingsUpsertWithoutQuestionnaireInput
  connect: QuestionnaireSettingsWhereUniqueInput
}

input QuestionnaireSettingsUpdateWithoutQuestionnaireDataInput {
  customer: CustomerUpdateOneRequiredInput
  title: String
  logo: String
  colourSettings: ColourSettingsUpdateOneRequiredInput
...
input QuestionnaireSettingsUpsertWithoutQuestionnaireInput {
  update: QuestionnaireSettingsUpdateWithoutQuestionnaireDataInput!
  create: QuestionnaireSettingsCreateWithoutQuestionnaireInput!
}
...
input QuestionnaireUpdateInput {
  ...
  description: String
  publicTitle: String
  setting: QuestionnaireSettingsUpdateOneRequiredWithoutQuestionnaireInput
  questions: QQuestionUpdateManyInput
}
...
input QuestionnaireUpdateOneRequiredWithoutSettingInput {
  create: QuestionnaireCreateWithoutSettingInput
  update: QuestionnaireUpdateWithoutSettingDataInput
  upsert: QuestionnaireUpsertWithoutSettingInput
  connect: QuestionnaireWhereUniqueInput
}
...
input QuestionnaireUpdateWithoutSettingDataInput {
  customer: CustomerUpdateOneRequiredWithoutQuestionnairesInput
  title: String
  description: String
  publicTitle: String
...
input QuestionnaireUpsertWithoutSettingInput {
  update: QuestionnaireUpdateWithoutSettingDataInput!
  create: QuestionnaireCreateWithoutSettingInput!
}
...
type Subscription {
  ...
  qQuestion(where: QQuestionSubscriptionWhereInput): QQuestionSubscriptionPayload
