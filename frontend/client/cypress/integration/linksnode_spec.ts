...
const CTALinkNodeText = /Follow us on Instagram and stay updated/i;
...
it('Custom link CTA', () => {
  ...
  cy.findByText(CTALinkNodeText).should('exist');
  ...
  cy.findByTestId(
    ...
    'have.attr', 'src', 'https://res.cloudinary.com/haas-storage/image/upload/v1618548214/activity_abc16g.svg',
  );
