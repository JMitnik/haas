...
/**
 * Reducer hook which handles the Lottie JSON state switch based on certain dispatches.
 */
export const useSliderAnimation = (): [SliderAnimationStateProps, React.Dispatch<SliderAnimationActionType>] => {
