...
import { ReactComponent as ChatIcon, ReactComponent as CursorIcon } from 'assets/icons/icon-chat-group.svg';
...
export const GlobalPermissionList = (type: SystemPermission): GlobalPermissionListPropertiesOutput => {
  switch (type) {
