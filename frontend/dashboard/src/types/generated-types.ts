...
export const GetDialogueLayoutDetailsDocument = gql`
    query GetDialogueLayoutDetails($workspaceId: ID!, $dialogueId: ID!, $healthInput: HealthScoreInput!) {
  customer(id: $workspaceId) {
    id
    dialogue(where: {id: $dialogueId}) {
      id
...
export function refetchGetDialogueLayoutDetailsQuery(variables?: GetDialogueLayoutDetailsQueryVariables) {
  return { query: GetDialogueLayoutDetailsDocument, variables };
}
...
export const GetDialogueStatisticsDocument = gql`
    query GetDialogueStatistics($customerSlug: String!, $dialogueSlug: String!, $prevDateFilter: DialogueFilterInputType, $statisticsDateFilter: DialogueFilterInputType, $startDateTime: String!, $endDateTime: String, $issueFilter: IssueFilterInput) {
  customer(slug: $customerSlug) {
    id
...
export namespace GetDialogueStatistics {
  ...
  export type History = (NonNullable<(NonNullable<(NonNullable<(NonNullable<GetDialogueStatisticsQuery['customer']>)['dialogue']>)['issues']>)['history']>);
  ...
  export type _History = NonNullable<(NonNullable<(NonNullable<(NonNullable<(NonNullable<GetDialogueStatisticsQuery['customer']>)['dialogue']>)['statistics']>)['history']>)[number]>;
